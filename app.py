...
- Correct answer index (0/1/2/3) must be RANDOMLY distributed. Do NOT always place correct answer at index 1.
...
Exam Context: Indian competitive exams (UPSC/SSC/NEET/JEE/Railways — use whichever fits this topic best)
...
- Focus on real facts, important dates, key names, formulas, or concepts that actually appear in competitive exam papers
- Each difficulty level must feel NOTICEABLY harder than the previous
- Wrong options should make even a prepared student think twice before eliminating them

Return format — a JSON array of exactly 15 objects. Each object:
{{
  "q": "Question text in Hindi",
  "options": ["Option A", "Option B", "Option C", "Option D"],
  "ans": 2,
  "level": "मध्यम",
  "explanation": "Specific reason why this answer is correct, with relevant fact/year/source if applicable."
}}

CRITICAL REMINDERS:
- "ans" must be the index (0, 1, 2, or 3) of the correct option inside the "options" array
- Randomize the position of correct answers — don't always put it at index 1
- Explanation must be specific and informative — not vague like "यह सही है"
...
Topic: {topic}"""
        ...
        response = groq_client.chat.completions.create(
            ...
            max_tokens=6000,
            temperature=0.4  # ✅ Slightly higher than 0.3 for better variety, but still accurate
        )
